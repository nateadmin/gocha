...
const en: Dictionary = {
  ...
  'language.subtitle': 'App language and incoming message translations in chats and groups. New accounts default to the language of your country.',
...
const he: Dictionary = {
  ...
  'language.title': 'שפה',
  'language.subtitle': 'שפת האפליקציה ותרגום הודעות נכנסות בצ׳אטים ובקבוצות. חשבונות חדשים מקבלים את שפת מדינת המוצא.',
...
const es: Dictionary = {
  ...
  'language.subtitle': 'Idioma de la app y traducción de mensajes recibidos en chats y grupos. Las cuentas nuevas usan el idioma de tu país.',
...
const fr: Dictionary = {
  ...
  'language.subtitle': 'Langue de l’app et traduction des messages reçus dans les discussions et les groupes. Les nouveaux comptes utilisent la langue de votre pays.',
...
const ar: Dictionary = {
  ...
  'language.subtitle': 'لغة التطبيق وترجمة الرسائل الواردة في الدردشات والمجموعات. الحسابات الجديدة تستخدم لغة بلدك.',
...
const ru: Dictionary = {
  ...
  'language.title': 'Язык',
  'language.subtitle': 'Язык приложения и перевод входящих сообщений в чатах и группах. Новые аккаунты получают язык вашей страны.',
...
const de: Dictionary = {
  ...
  'language.subtitle': 'App-Sprache und Übersetzung eingehender Nachrichten in Chats und Gruppen. Neue Konten nutzen die Sprache deines Landes.',
...
const pt: Dictionary = {
  ...
  'settings.verified': 'Verificado',
  'language.title': 'Idioma',
  'language.subtitle': 'Idioma do app e tradução das mensagens recebidas em conversas e grupos. Novas contas usam o idioma do seu país.',
